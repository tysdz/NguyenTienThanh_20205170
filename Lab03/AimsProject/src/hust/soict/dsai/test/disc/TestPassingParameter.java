...
public class TestPassingParameter {
    ...
    public static void changeTittle(DigitalVideoDisc dvd, String title) {
        ...
        //dvd = new hust.soict.dsai.aims.disc.DigitalVideoDisc(oldTitleString); //vi no tham chieu toi vi tri khac roi, nen co thay doi ve oldTittle thi cung khong anh huong gi toi jungleDVD
        //System.out.println ("The current jungle title is: " + dvd.getTitle());
    }
