...
public class Aims {
    ...
    private static void initData(Store store) {
        store.addMedia(new DigitalVideoDisc("The Lion king", string2, string3, i, f));
        store.addMedia(new DigitalVideoDisc("The shape of water", string2, string3, i, f));
        store.addMedia(new DigitalVideoDisc("The Fallen kingdom", string2, string3, i, f));
        ...
        store.addMedia(new DigitalVideoDisc("The Avengers", string2, string3, i, f));
